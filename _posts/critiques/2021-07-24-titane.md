...
{% for i in (1..2) %}★{% endfor %}{% for i in (3..5) %}☆{% endfor %}
</p>
...
{% for i in (1..2) %}<p style = "font-family:Times;font-size:16px;">♥</p>{% endfor %}{% for i in (3..5) %}<p style = "font-family:Times;font-size:16px;">♡</p>{% endfor %}
