---
layout: review
title: "{%include movie name='Titane|0'%}"
...
Le peu de plaisir que j'ai tiré de mon visionnage de {%include movie name='Titane|0'%}, venait des quelques tentatives d'humour noir au début et à la fin du film. Le film est un mélange de {%include movie name='Under the Skin|2013'%}, les œuvres de Bilal, {%include movie name='Crash|1996'%} de Cronenberg et de la French Horror à la {%include movie name='Martyrs|2008'%}. Je n'avais non plus aimé {%include movie name='Crash|0'%} et {%include movie name='Martyrs|0'%} mais si vous êtes fan jetez un coup d'œil à {%include movie name='Titane|0'%}.

Si je peux conseiller un autre film de body-horror, aussi très récent : {%include movie name='Possessor|2020'%} est plus intéressant et étrange. Réalisé par Brandon Cronenberg, comme par hasard le fils de David. Ne le regardez pas en famille, et si vous choisissez de regarder la version non-censurée, ne le regardez pas avec un autre humain dans la pièce.
