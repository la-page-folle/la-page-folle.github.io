...
{{ site.post | where_exp: "item", "item.title == 'A Nightmare on Elm Street' and item.year == '1984'" }}

{% assign post = site.post | where_exp: "item", "item.title == 'A Nightmare on Elm Street' and item.year == '1984'" | first %}{% if post %}[{{ post.title }}]({{ post.url }}){% else %}A Nightmare on Elm Street{% endif %}

{% assign post = site.post | where_exp: "item", "item.title == 'A Nightmare on Elm Street' and item.year == '19'" | first %}{% if post %}[{{ post.title }}]({{ post.url }}){% else %}A Nightmare on Elm Street{% endif %}
