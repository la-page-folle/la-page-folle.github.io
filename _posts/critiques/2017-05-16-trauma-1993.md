...
{% assign post = site.posts | where: "title", "A Nightmare on Elm Street" and "year", "1984" | first %}{% if post %}[{{ post.title }}]({{ post.url }}){% else %}A Nightmare on Elm Street{% endif %}

{% assign post = site.posts | where: "title", "A Nightmare on Elm Street" and "year", "19" | first %}{% if post %}[{{ post.title }}]({{ post.url }}){% else %}A Nightmare on Elm Street{% endif %}
