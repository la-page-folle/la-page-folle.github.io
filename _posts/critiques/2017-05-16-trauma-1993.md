...
{% include movie.html text='A Nightmare on Elm Street|1984' %}

Note : {% include movie.html text='A Nightmare on Elm Street|1984' %}Cette critique est ancienne et ne reflète plus nécessairement l'opinion du rédacteur. Elle sera prochainement remplacée.{% include movie.html text='A Nightmare on Elm Street|1984' %}
